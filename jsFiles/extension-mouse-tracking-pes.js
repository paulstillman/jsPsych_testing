    ...
    class MouseTrackingExtension {
        constructor(jsPsych) {
            ...
            this.on_load = () => {
                ...
                if (this.eventsToTrack.includes("mouseleave")) {
                    window.addEventListener("mouseleave", this.mouseLeaveEventHandler);
                }
            };
            this.on_finish = () => {
                ...
                if (this.eventsToTrack.includes("mouseleave")) {
                    window.removeEventListener("mouseleave", this.mouseLeaveEventHandler);
                }
                return {
            ...
            this.mouseLeaveEventHandler = ({ clientX: x, clientY: y }) => {
                const event_time = performance.now();
                const t = Math.round(event_time - this.currentTrialStartTime);
                this.currentTrialData.push({ x, y, t, event: "mouseleave" });
            };
